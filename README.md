...
Consulte [docs/PROJECT_BRIEF.md](docs/PROJECT_BRIEF.md) para o briefing completo de marca, público, copy e diretrizes visuais, [docs/CODEBASE_STATE.md](docs/CODEBASE_STATE.md) para um resumo técnico do estado atual do código (handoff), e [docs/DEPLOYMENT_CHECKLIST.md](docs/DEPLOYMENT_CHECKLIST.md) para as pendências reais antes de colocar o site no ar.
